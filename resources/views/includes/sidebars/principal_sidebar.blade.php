  ...
  @endif" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{route('principaldashboard.profile.index')}}" class="d-block">{{ Auth::user()->first_name }} {{ Auth::user()->middle_name }}  {{ Auth::user()->last_name }}</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ (request()->is('principaldashboard/profile*')) ? 'menu-open' : '' }}">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="{{route('principaldashboard.profile.emergency_contacts.index')}}" class="nav-link {{ (request()->is('admindashboard/profile/emergency_contacts')) ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
