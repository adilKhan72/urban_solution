...
@section('content')
   <!-- Main content -->
    ...
    <!-- /.content -->
    @include('Principal_dashboard.profile.skills.createskillmodal')
    @include('Principal_dashboard.profile.skills.editskillmodal')
    @include('Principal_dashboard.profile.skills.deleteskillmodal')
    @endsection
  ...
  var  datatbl = $('#example2').DataTable({
    "paging": true,
      ...
      processing: true,
      serverSide: true,
      ajax: '{{URL::route("principaldashboard.profile.skills.getdatatable")}}',
               columns: [
    ...
    $('#createskillform').on('submit',function(event){
        ...
        $.ajax({
          url: '{{URL::route("principaldashboard.profile.skills.store")}}',
          type:"POST",
          dataType: "JSON",
          cache: false,
          contentType: false,
    ...
    $('#editskillform').on('submit',function(event){
        ...
        files = new FormData(this);
        $.ajax({
          url: '{{URL::route("principaldashboard.profile.skills.edit")}}',
          type:"POST",
          dataType: "JSON",
          cache: false,
          contentType: false,
    ...
    $('.delete_button_id').click(function() {
        ...
        //alert(value);
        $.ajax({
          url: '{{URL::route("principaldashboard.profile.skills.delete")}}',
          type:"POST",
          data:{
            id:value,
          },
