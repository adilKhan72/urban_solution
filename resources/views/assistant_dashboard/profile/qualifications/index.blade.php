...
@section('content')
    ...
    <!-- /.content -->
    @include('assistant_dashboard.profile.qualifications.editqualificationmodal')
    @include('assistant_dashboard.profile.qualifications.createqualificationmodal')
    @endsection
  ...
  $(document).ready(function(){
    ...
    $('#select_educational_degree2').select2({
      ...
      $('.delete_qualification').click(function() {
        ...
        //alert("Hello");
        $.ajax({
          url: '{{URL::route("assistantdashboard.profile.qualitifcations.delete")}}',
          type:"POST",
          data:{
            id:value,
          },
