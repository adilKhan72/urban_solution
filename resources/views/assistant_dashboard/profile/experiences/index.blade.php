...
@section('content')
    ...
    <!-- /.content -->
    @include('assistant_dashboard.profile.experiences.editexperiencemodal')
    @include('assistant_dashboard.profile.experiences.createexperiencemodal')
    @endsection
  ...
  $(document).ready(function(){
      ...
      $('.delete_experience').click(function() {
        ...
        //alert("Hello");
        $.ajax({
          url: '{{URL::route("assistantdashboard.profile.experiences.delete")}}',
          type:"POST",
          data:{
            id:value,
          },
