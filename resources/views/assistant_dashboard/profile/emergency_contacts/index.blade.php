...
@section('content')
   <!-- Main content -->
    ...
    <!-- /.content -->
    @include('assistant_dashboard.profile.emergency_contacts.createemergency_contactsmodal')
    @include('assistant_dashboard.profile.emergency_contacts.editemergency_contactsmodal')
    @include('assistant_dashboard.profile.emergency_contacts.deleteemergency_contactsmodal')
    @endsection
  ...
  var  datatbl = $('#example2').DataTable({
    "paging": true,
      ...
      processing: true,
      serverSide: true,
      ajax: '{{URL::route("assistantdashboard.profile.emergency_contacts.getdatatable")}}',
               columns: [
                        { data: 'name', name: 'name' },
    ...
    $('#createemergency_contactform').on('submit',function(event){
        ...
        $.ajax({
          url: '{{URL::route("assistantdashboard.profile.emergency_contacts.store")}}',
          type:"POST",
          dataType: "JSON",
          cache: false,
          contentType: false,
    ...
    $('#editemergency_contactform').on('submit',function(event){
        ...
        files = new FormData(this);
        $.ajax({
          url: '{{URL::route("assistantdashboard.profile.emergency_contacts.edit")}}',
          type:"POST",
          dataType: "JSON",
          cache: false,
          contentType: false,
    ...
    $('.delete_button_id').click(function() {
        ...
        //alert(value);
        $.ajax({
          url: '{{URL::route("assistantdashboard.profile.emergency_contacts.delete")}}',
          type:"POST",
          data:{
            id:value,
          },
