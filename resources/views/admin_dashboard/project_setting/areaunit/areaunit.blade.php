...
<script>
  $(document).ready(function(){
    ...
    "paging": true,
      ...
      processing: true,
      serverSide: true,
      ajax: '{{URL::route("admindashboard.projectsetting.areaunit")}}',
               columns: [
    ...
    //     $.ajax({
    //       url: '{{URL::route("admindashboard.profile.areaunits.store")}}',
    //       type:"POST",
    //       dataType: "JSON",
    //       cache: false,
    //       contentType: false,
    ...
    //     files = new FormData(this);
    //     $.ajax({
    //       url: '{{URL::route("admindashboard.profile.areaunits.edit")}}',
    //       type:"POST",
    //       dataType: "JSON",
    //       cache: false,
    //       contentType: false,
    ...
    //     //alert(value);
    //     $.ajax({
    //       url: '{{URL::route("admindashboard.profile.areaunits.delete")}}',
    //       type:"POST",
    //       data:{
    //         id:value,
    //       },
