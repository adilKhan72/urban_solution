...
@section('content')
    ...
    <section class="content">
      ...
      <form action="javascript:;" autocomplete="off"  method="post" class="" id="editprojectform_1" files="true" name="editprojectform_1" enctype="multipart/form-data"  role="form">

      <input type="hidden" id="edit_project_id" name="edit_project_id" <?php if(isset($project) && !empty($project->id)){ echo "value='$project->id'"; }?>>
      <div class="row">
...
$(document).ready(function(){
  ...
  $('#editprojectform_1').on('submit',function(event){
    $('.ajax_input').removeClass("is-invalid");
        ...
        $.ajax({
          url: '{{URL::route("admindashboard.projecttab.editstore")}}',
          type:"POST",
          dataType: "JSON",
          cache: false,
          contentType: false,
