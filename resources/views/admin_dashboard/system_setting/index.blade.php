...
<div class="form-group">
    ...
    <label for="exampleInputFile"> 
    <span class="label_for_input_2 label_success_form_3" id="favicon_logo_label"></span>
    Favicon Logo
    </label>
...
<div class="col-12">
<input type="submit" value="Save Changes" class="btn btn-success float-right">
<span class="text-danger ajax_errors_2" id="errors_form_3"> </span>
<span class="text-success ajax_errors_2" id="success_form_3"> </span>
</div>
</div>
</form>
                </div>
 ...
 $.ajax({
   ...
   error: function(jqXHR, exception){
     ...
     if (jqXHR.status == 422) {
         ...
         $('#errors_form_2').append(jqXHR.responseJSON.errors.header_logo[0]);
